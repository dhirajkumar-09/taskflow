  ...
  return (
    <div className="min-h-screen flex" style={{ background: 'var(--bg)' }}>
      {/* Left branding panel */}
        ...
        <div className="glow-orb floaty w-96 h-96 -top-20 -left-10"></div>
        <div className="glow-orb w-72 h-72 bottom-0 right-0" style={{ opacity: 0.3 }}></div>

        <div className="relative z-10 max-w-md">
          <div className="inline-flex items-center gap-2 mb-8">
            <div className="w-9 h-9 rounded-lg flex items-center justify-center" style={{ background: 'linear-gradient(135deg, var(--accent), var(--accent-2))' }}>
          ...
          <div className="mt-10 space-y-4">
            {['Boards that update instantly for everyone', 'Drag, drop, done — no friction', 'Built for small teams that move fast'].map((text) => (
